...
/*
Package app_grpc_enterprise is a reverse proxy.
...
func RegisterUserServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UserServiceServer) error {
	...
	mux.Handle("POST", pattern_UserService_GetById_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
var (
	pattern_UserService_GetById_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"coding-core", "UserService", "getById"}, "", runtime.AssumeColonVerbOpt(true)))
)
